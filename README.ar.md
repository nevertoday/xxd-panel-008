...
يحتفظ المستودع بمجلد [`assets/examples/`](assets/examples/) للأعمال القادمة. لن يُضاف إلا عمل مكتمل بأسلوب 008 ومؤكد من صاحب المشروع؛ ولن تُستخدم منشورات أو صور من أساليب أخرى كعناصر مؤقتة.

ستعرض النماذج القادمة قدرة 008 على التكيف فقط، ولن تصبح موضوعاتها أو أجهزتها المكانية أو ألوانها أو نصوصها أو أبعادها مراجع للتوليد أو قيماً افتراضية.

## أربعة مخرجات ومنطق واحد لقصيدة مكانية
...
| --- | --- | --- |
| `top-bottom` | متكيف مع المصدر | الصورة كاملة في الأعلى وفضاء 008 المستحيل بالباستيل في الأسفل؛ يحتفظ اللوحان بالمقاس وينقسمان 50/50 بدقة |
| `left-right` | متكيف مع المصدر | الصورة كاملة في اليسار وفضاء 008 المستحيل بالباستيل في اليمين؛ يحتفظ اللوحان بالمقاس وينقسمان 50/50 بدقة |
...
الأولوية هي: البكسلات الدقيقة التي يحددها المستخدم، ثم النسبة أو الوجهة، ثم التكيف مع المصدر في الأنماط العادية. نسبة 3:4 في ملف `008.md` كانت لوحة إبداعية أولى وليست قيمة افتراضية صامتة في المهارة الحالية.
...
ينشئ نموذج الصور استعارة مكانية مرتبطة بالمصدر، وإسقاطاً متساوي القياس، وباستيل ديناميكياً، ونقطة قفز واحدة، وثلاثي أبعاد مطفأ شديد النقاء، وملاحظة هندسية صغيرة. ولا يتولى `scripts/compose_panel.py` سوى تخطيط اللوحة والتركيب النقطي الدقيق بنسبة 50/50 وتثبيت المقاس والمراجعة.
